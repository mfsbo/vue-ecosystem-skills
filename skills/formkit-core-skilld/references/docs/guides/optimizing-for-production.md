...
Follow this guide to learn how to slim down your FormKit installation for production.
...
> **Tip:** In the above examples, we import the en and de locales. These include messages that are not used in our example. Instead, we could have provided our own custom messages directly:createI18nPlugin({
  en: {
    validation: {
