...
> **Tip:** Need more flexibility than the native HTML tel input provides? Check out the mask input available in FormKit Pro.
...
> **Tip:** Phone number formats vary greatly around the world (some localities even include letters in their phone numbers!) — be cautious validating phone numbers unless you know your audience is exclusively from a given location.
...
Additional slot data specific to the `tel` input:
