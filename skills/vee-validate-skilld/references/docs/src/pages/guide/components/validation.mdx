...
There is an official integration available for Zod validation that you can use as a drop-in replacement for `yup`. Check the [zod integration page](/integrations/zod-schema-validation).
