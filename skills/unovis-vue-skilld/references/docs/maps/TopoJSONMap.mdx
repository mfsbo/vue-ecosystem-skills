...
TopoJSON data format. You can provide your own custom _topojson_
...
_topojson_, every country has a unique id that corresponds to the ISO 3166-1 alpha-2
...
geo projections for more information.
