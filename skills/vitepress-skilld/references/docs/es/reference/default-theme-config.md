...
Una opción para dar soporte para buscar en su sitio de documentación usando Algolia DocSearch. Obtenga más información en [Tema predeterminado: Buscar](./default-theme-search).
