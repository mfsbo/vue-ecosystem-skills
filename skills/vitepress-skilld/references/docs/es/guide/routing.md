...
- Vercel requiere activación de la opción `cleanUrls` en `vercel.json`.
...
Los paths reesctritos son compilados usando el paquete `path-to-regexp` - consulte su documentación para una sintaxis más avanzada.
