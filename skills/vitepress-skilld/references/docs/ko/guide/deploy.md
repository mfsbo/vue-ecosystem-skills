...
1. `heroku-buildpack-static`에 제공된 문서와 가이드를 따르세요.
...
Edgio에 VitePress 앱 생성 및 배포하기를 참고하세요.

### Kinsta 정적 사이트 호스팅 {#kinsta-static-site-hosting}

VitePress 웹사이트를 Kinsta에 배포하려면 이 지침을 따르세요.

### Stormkit

VitePress 프로젝트를 Stormkit에 배포하려면 이 지침을 따르세요.
...
추가 정보는 공식 nginx 문서, 이슈 #2837, #3235 및 Mehdi Merah의 블로그 포스트에서 확인할 수 있습니다.
