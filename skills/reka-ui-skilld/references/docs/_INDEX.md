...
:features="[
 ...
 'Can ex...
- [Alert Dialog](./content/docs/components/alert-dialog.md): <Highlights
:features="[
 'Focus is automatically trapped.',
 'Can be controlled or uncontrolled.',
 'Manages screen reader announcements with <cod...
- [Aspect Ratio](./content/docs/components/aspect-ratio.md): <Highlights
:features="[
...
:features="[
 ...
 'Optionally delay f...
- [Calendar](./content/docs/components/calendar.md): <Badge>Alpha</Badge>
- [Checkbox](./content/docs/components/checkbox.md): <Highlights
:features="[
...
:features="[
 ...
 'Focu...
- [Context Menu](./content/docs/components/context-menu.md): <Highlights
:features="[
 'Supports submenus with configurable reading direction.',
 'Supports items, labels, groups of items.',
 'Supports checkab...
- [Date Field](./content/docs/components/date-field.md): <Badge>Alpha</Badge>
- [Date Picker](./content/docs/components/date-picker.md): <Badge>Alpha</Badge>
- [Date Range Field](./content/docs/components/date-range-field.md): <Badge>Alpha</Badge>
- [Date Range Picker](./content/docs/components/date-range-picker.md): <Badge>Alpha</Badge>
- [Dialog](./content/docs/components/dialog.md): <Highlights
:features="[
 'Supports modal and non-modal modes.',
 'Focus is automatically trapped when modal.',
 'Can be controlled or uncontrolled...
- [Dropdown Menu](./content/docs/components/dropdown-menu.md): <Highlights
:features="[
 'Can be controlled or uncontrolled.',
 'Supports submenus with configurable reading direction.',
 'Supports items, labels...
- [Editable](./content/docs/components/editable.md): <Highlights
:features="[
 'Full keyboard navigation',
 'Can be controlled or uncontrolled',
...
/>
- [Hover Card](./content/docs/components/hover-card.md): <Highlights
:features="[
 'Can be controlled or uncontrolled.',
 'Customize side, alignment, offsets, collision handling.',
 'Optionally render a p...
- [Label](./content/docs/components/label.md): <Highlights
:features="[
 'Text selection is prevented when double clicking label.',
 'Supports nested controls.',
]"
/>
- [Listbox](./content/docs/components/listbox.md): <Highlights
:features="[
 'Can be controlled or uncontrolled.',
 'Supports items, labels, groups of items.',
 'Focus is fully managed.',
 'Full key...
- [Menubar](./content/docs/components/menubar.md): <Highlights
:features="[
 'Can be controlled or uncontrolled.',
 'Supports submenus with configurable reading direction.',
 'Supports items, labels...
...
:features="[
 ...
 'Supports submenus.',
 'Opti...
- [Number Field](./content/docs/components/number-field.md): <Highlights
:features="[
 'Full keyboard navigation.',
 'Can be controlled or uncontrolled.',
 'Support button hold and wheel event.',
 'Support nu...
- [Pagination](./content/docs/components/pagination.md): <Highlights
:features="[
 'Enable quick access to first, or last page',
 'Enable to show edges constantly, or not',
]"
/>
- [Pin Input](./content/docs/components/pin-input.md): <Highlights
:features="[
 'Full keyboard navigation.',
 'Can be controlled or uncontrolled.',
 'Supports pasting from clipboard',
 'Emit event when...
- [Popover](./content/docs/components/popover.md): <Highlights
:features="[
 'Can be controlled or uncontrolled.',
 'Customize side, alignment, offsets, collision handling.',
 'Optionally render a p...
- [Progress](./content/docs/components/progress.md): <Highlights
:features="[
 'Provides context for assistive technology to read the progress of a task.',
]"
/>
- [Radio Group](./content/docs/components/radio-group.md): <Highlights
:features="[
 'Full keyboard navigation.',
 'Supports horizontal/vertical orientation.',
 'Can be controlled or uncontrolled.',
...
/>
- [RangeCalendar](./content/docs/components/range-calendar.md): <Badge>Alpha</Badge>
- [Scroll Area](./content/docs/components/scroll-area.md): <Highlights
:features="[
 'Scrollbar sits on top of the scrollable content, taking up no space.',
 'Scrolling is native; no underlying position mov...
- [Select](./content/docs/components/select.md): <Highlights
:features="[
 'Can be controlled or uncontrolled.',
 'Offers 2 positioning modes.',
 'Supports items, labels, groups of items.',
 'Focu...
- [Separator](./content/docs/components/separator.md): Install the component from your command line.
- [Slider](./content/docs/components/slider.md): <Highlights
:features="[
 'Can be controlled or uncontrolled.',
 'Supports multiple thumbs.',
 'Supports a minimum value between thumbs.',
 'Suppor...
- [Splitter](./content/docs/components/splitter.md): <Highlights
:features="[
...
:features="[
 'Can be controlled or uncontrolled.',
 'Supports horizontal/vertical orientation.',
 'Supports automatic/manual activatio...
- [Tags Input](./content/docs/components/tags-input.md): <Highlights
:features="[
 'Can be controlled or uncontrolled.',
 'Full keyboard navigation.',
...
- [Toggle Group](./content/docs/components/toggle-group.md): <Highlights
:features="[
 'Full keyboard navigation.',
 'Supports horizontal/vertical orientation.',
 'Support single and multiple pressed buttons....
- [Toggle](./content/docs/components/toggle.md): <Highlights
:features="['Full keyboard navigation.', 'Can be controlled or uncontrolled.']"
/>
- [Toolbar](./content/docs/components/toolbar.md): Install the component from your command line.
- [Tooltip](./content/docs/components/tooltip.md): <Highlights
:features="[
...
- [Animation/Transition](./content/docs/guides/animation.md): Adding animation to Reka UI should feel similar to any other component, but there are some caveats noted here in regards to exiting animations with...
- [Composition](./content/docs/guides/composition.md): Use the asChild prop to compose Reka's functionality onto alternative
element types or your own Vue components.
- [Controlled State](./content/docs/guides/controlled-state.md): Reka UI provides flexible state management for components, allowing developers to use either controlled or uncontrolled state. Understanding when t...
- [Dates & Times](./content/docs/guides/dates.md): The inner-workings of our date-related components are heavily inspired by the research and work done
by the React Aria team at Adobe, who have crea...
- [Internationalization (RTL)](./content/docs/guides/i18n.md): This documentation provides guidance on how to utilize multi-directional support in Reka UI with SSR support. Reka UI rely on Floating UI to positi...
- [Inject Context](./content/docs/guides/inject-context.md): Utilize injectContext to enhance component composition in Reka UI, enabling powerful and flexible UI development.
- [Migration - Radix Vue to Reka UI](./content/docs/guides/migration.md): First and foremost, you need to install the latest reka-ui.
- [Namespaced components](./content/docs/guides/namespaced-components.md): Reka UI design pattern is to create primitives for each component, and allow user to construct or compose components however they want.
- [Server side rendering](./content/docs/guides/server-side-rendering.md): Server side rendering or SSR, is a technique used to render components to HTML on the server, as opposed to rendering them only on the client.
- [Styling](./content/docs/guides/styling.md): You are in control of all aspects of styling, including functional styles. For example, by default, a Dialog Overlay won't cover the entire viewpor...
- [Virtualization](./content/docs/guides/virtualization.md): Learn how to efficiently render large datasets with Reka UI, powered by @tanstack/vue-virtual.

## content/docs/overview (5)

- [Accessibility](./content/docs/overview/accessibility.md): We take care of many of the difficult implementation details related to accessibility, including aria and role attributes, focus management, and ke...
- [Getting started](./content/docs/overview/getting-started.md): In this quick tutorial, we will install and style the Popover component.
- [Installation](./content/docs/overview/installation.md): A quick tutorial to walk through installing the packages, as well as the supported plugins.
- [Introduction](./content/docs/overview/introduction.md): An open-source UI component library for building high-quality, accessible
design systems and web apps using <a href="https://vuejs.org" target="bla...
- [Releases](./content/docs/overview/releases.md): Latest releases on github

## content/docs/utilities (16)

- [Config Provider](./content/docs/utilities/config-provider.md): <Highlights
:features="[
 'Enables all primitives to inherit global reading direction.',
 'Enables changing the behavior of scroll body when settin...
- [Focus Scope](./content/docs/utilities/focus-scope.md): Focus Scope provides enhanced control over keyboard focus management within component boundaries. It can trap focus within its container and option...
- [Presence](./content/docs/utilities/presence.md): How is this component different from Vue Transition?
- [Primitive](./content/docs/utilities/primitive.md): When you are building a component, in some cases you might want to allow user to compose some functionalities onto the underlying element, or alter...
- [Roving Focus](./content/docs/utilities/roving-focus.md): Learn more about roving tabindex in Keyboard Navigation Inside Composite Components
- [Slot](./content/docs/utilities/slot.md): How is this component different from Vue native slot?
- [useDateFormatter](./content/docs/utilities/use-date-formatter.md): More information on the DateFormatter here.
- [useDirection](./content/docs/utilities/use-direction.md)
- [useEmitAsProps](./content/docs/utilities/use-emit-as-props.md): When you are building a wrapper for a component, one of the biggest painpoint is to forward all the emitted events from components.
- [useFilter](./content/docs/utilities/use-filter.md): useFilter provides utility functions for performing locale-aware string filtering using Intl.Collator. It ensures proper Unicode handling and allow...
- [useForwardExpose](./content/docs/utilities/use-forward-expose.md): When building a component, if we have a non-single root node component, the template refs will not return the DOM element via $el (read more) , thu...
- [useForwardPropsEmits](./content/docs/utilities/use-forward-props-emits.md): This composable is just a wrapper for useForwardProps & useEmitAsProps composables. Doing so it returns only 1 object that is designed to be use wi...
- [useForwardProps](./content/docs/utilities/use-forward-props.md): When you are building a wrapper for a component, in some cases you want to ignore Vue Props Boolean Casting.
- [useId](./content/docs/utilities/use-id.md): Vue 3.5 released an official client-server stable solution for useId.
- [useLocale](./content/docs/utilities/use-locale.md)
- [Visually Hidden](./content/docs/utilities/visually-hidden.md): <Highlights
:features="[
...
- [Circular Progress](./content/examples/progress-circular.md): Rendering progress bar as a Circular Progress.
- [Slider with Number Field](./content/examples/slider-number-field.md): Render a Slider with a Number Field that shows and interact with the values of the Slider.
